...
## Exercise 1 (ex01): Total amounts for Travel, Family, Children films
...
## Exercise 2 (ex02): Average films per category with FLOOR and CEIL
...
## Exercise 3 (ex03): Categories with films above average (with names)
...
## Exercise 4 (ex04): Max purchase with CASE statement for value_rate
...
## Exercise 5 (ex05): Customer, category, and payment amount
...
## Exercise 6 (ex06): Pivot table - total amount by customer and category
...
## Exercise 7 (ex07): On time vs Late returns using DATE_PART
...
## Exercise 8 (ex08): Staff initials using SUBSTRING
...
## Exercise 9 (ex09): Most paid movie by rating using RANK window function
...
## Exercise 10 (ex10): Top 10 actors by film count using ROW_NUMBER
...
## Exercise 11 (ex11): Monthly payment with LAG function
...
## Exercise 12 (ex12): Monthly payment with LEAD function
